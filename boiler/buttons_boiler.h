...
void check_buttons()
{
	...
	while (Key(3) == 1)
	{
		...
		if (t_push>=3000)
		{
			//Если текущий режим управления автоматический
			if (flag_R==0)
			{
				//Установка режима "ручное управление"
				flag_R=1;
				skv_s[0] = 'R';
				flag_O = 1;
				break;
			}
			//Если текущий режим управления ручной
			else if (flag_R==1)
			{
				//Установка режима "автоматическое управление"
				flag_R=0;
				skv_s[0] = 'A';
				flag_O = 1;
				break;
