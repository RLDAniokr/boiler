...
//**************************************************
//* Редактирование программы: Богатырев Н.С.             *
//* Дата последней редакции программы: 01.03.2019. *
//**************************************************

/*
01.03.2019
Добавлен принудительный выход из меню, если в течении 25с не нажимают на кнопки
(Отредактированна страндартная библиотека для плат серии MC - Menu.h).
Добавленно подменю для ввода пароля (Без ввода правильного пароля, изменить параметры котла будет невозможно,
при выходе из меню пароль обнуляется).
*/
...
// Параметры меню
#define MAX_ELEMENTS_MENU 40
#define MAX_SUB_MENUS 19
